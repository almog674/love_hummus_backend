...
async def add_rating_to_hummusia(hummusia_id: str, rating_given: int):
    """
    ...
    Returns a string which tells if the action was a success
    """
    hummusia = DB_MANAGER._db_query.execute_query({"id": hummusia_id},
                                                  DB_MANAGER.humusiot_collection)[HummusRouter.ONE_ID_PER_HUMMUSIA]
